...
//			p := &Project{}
//			callbackCount := 0
//			p.EventsForRange(tt.args.startBeat, tt.args.endBeat, tt.args.steps, tt.args.easeFunc, func(ctx Timing) {
...
//			p := &Project{}
//			callbackCount := 0
//			p.EventsForBeats(tt.args.startBeat, tt.args.duration, tt.args.count, func(ctx Timing) {
//				if ctx.B != tt.callbackOnBeat[callbackCount] {
//					t.Fatalf("got %dth callback on beat %f; want callback on beat %f instead",
//						callbackCount, ctx.B, tt.callbackOnBeat[callbackCount],
//					)
